...
if __name__ == '__main__':
    # 测试base_dim, embed_dim, 余弦退火, batch_size
    set_seed(2026)
    create_dir()
    ...
    agent = DoubleDQNAgentPER(generator.coeff_dim, generator.mask_dim, device=DEVICE, base_dim=1024, embed_dim=32, total_episode=TOTAL_EPISODES, batch_size=1024)
